...
```javascript
stdevtk = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-stdevtk@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-stdevtk/tags). For example,

```javascript
stdevtk = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-stdevtk@v0.2.2-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var stdevtk = require( 'path/to/vendor/umd/stats-base-stdevtk/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-stdevtk@umd/browser.js"></script>
```
...
[test-image]: https://github.com/stdlib-js/stats-base-stdevtk/actions/workflows/test.yml/badge.svg?branch=v0.2.2
[test-url]: https://github.com/stdlib-js/stats-base-stdevtk/actions/workflows/test.yml?query=branch:v0.2.2
...
[deno-readme]: https://github.com/stdlib-js/stats-base-stdevtk/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-stdevtk/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-stdevtk/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-stdevtk/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-stdevtk/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/stats-base-stdevtk/blob/main/branches.md
